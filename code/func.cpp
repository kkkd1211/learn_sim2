...
//    }
    ...
    tmp+=2*Gene[3]->error(0,10);
    tmp+=1*Gene[3]->error(60,75);
    tmp+=3*Gene[4]->error(80,100);
    tmp+=1*Gene[4]->error(10,50);
    tmp+=1*Gene[5]->error(50,65);
    tmp+=3*Gene[6]->error(65,100);
    tmp+=1*Gene[6]->error(15,50);
